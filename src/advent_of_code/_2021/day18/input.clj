(ns advent-of-code.-2021.day18.input
...
;; direction the keys went if you help one of the smaller snailfish
...
;; the pair. Here are some example snailfish numbers, one snailfish
;; number per line:
...
;;              [[[[4 3] 4] 4] [7 [[8 4] 9]]] + [1 1]:
(def  sample3-step1 [[[[[4 3] 4] 4] [7 [[8 4] 9]]]  [1 1]])
;; after addition: [[[[[4 3] 4] 4] [7 [[8 4] 9]]] [1 1]]
(def sample3-step2 [[[[0 7] 4] [7 [[8 4] 9]]] [1 1]])
;; after explode:  [[[[0 7] 4] [7 [[8 4] 9]]] [1 1]]
(def sample3-step3 [[[[0 7] 4] [15 [0 13]]] [1 1]])
;; after explode:  [[[[0 7] 4] [15 [0 13]]] [1 1]]
(def sample3-step3 [[[[0 7] 4] [[7 8] [0 13]]] [1 1]])
;; after split:    [[[[0 7] 4] [[7 8] [0 13]]] [1 1]]
(def sample3-step4 [[[[0 7] 4] [[7 8] [0 [6 7]]]] [1 1]])
;; after split:    [[[[0 7] 4] [[7 8] [0 [6 7]]]] [1 1]]
(def sample3-step5 [[[[0 7] 4] [[7 8] [6 0]]] [8 1]])
...
(def input-raw 
  (-> "./resources/_2021/day18/input.txt" slurp trim))


(def input (-> input-raw fmt))
...
(def tiny-sample1
  [[1 1]
   ...
   [3 3]
   [4 4]])
(def tiny-sample1-sol [[[[1 1] [2 2]] [3 3]] [4 4]])
...
(def tiny-sample2
  [[1 1]
   ...
   [4 4]
   [5 5]])
(def tiny-sample2-sol [[[[3 0] [5 3]] [4 4]] [5 5]])
...
(def tiny-sample3
  [[1 1]
   ...
   [5 5]
   [6 6]])
(def tiny-sample3-sol [[[[5 0] [7 4]] [5 5]] [6 6]])
...
(def homework-mag 4140)

;; The magnitude of this final sum is 4140.

;; Add up all of the snailfish numbers from the homework assignment
...
;; You notice a second question on the back of the homework
;; assignment:
...
;; The largest magnitude of the sum of any two snailfish numbers in 
;; this list is 3993. This is the magnitude of 
;; [[2,[[7,7],7]],[[5,8],[[9,3],[0,2]]]] + 
;; [[[0,[5,8]],[[1,7],[9,6]]],[[4,[1,2]],[[1,4],2]]], 
...
(def homework-high-magnitude-sol 3993)
